...
include_once(__DIR__ . "/Base64DecodeStreamFilter.php");
include_once(__DIR__ . "/Base64EncodeStreamFilter.php");
include_once(__DIR__ . "/CharsetStreamFilter.php");
include_once(__DIR__ . "/ConvertStreamFilter.php");
include_once(__DIR__ . "/UUDecodeStreamFilter.php");
include_once(__DIR__ . "/UUEncodeStreamFilter.php");
