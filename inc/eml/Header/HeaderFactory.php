...
include_once(__DIR__ . '/Consumer/ConsumerService.php');
include_once(__DIR__ . '/AbstractHeader.php');
include_once(__DIR__ . '/AddressHeader.php');
include_once(__DIR__ . '/DateHeader.php');
include_once(__DIR__ . '/GenericHeader.php');
include_once(__DIR__ . '/ParameterHeader.php');
include_once(__DIR__ . '/SubjectHeader.php');
