...
include_once(__DIR__ . "/AbstractConsumer.php");
include_once(__DIR__ . "/AddressBaseConsumer.php");
include_once(__DIR__ . "/AddressGroupConsumer.php");
include_once(__DIR__ . "/AddressConsumer.php");
include_once(__DIR__ . "/CommentConsumer.php");
include_once(__DIR__ . "/DateConsumer.php");
include_once(__DIR__ . "/GenericConsumer.php");
include_once(__DIR__ . "/ParameterConsumer.php");
include_once(__DIR__ . "/QuotedStringConsumer.php");
include_once(__DIR__ . "/SubjectConsumer.php");
