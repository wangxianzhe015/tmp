...
include_once(__DIR__ . '/Header/HeaderFactory.php');
include_once(__DIR__ . '/Header/Consumer/ConsumerService.php');
include_once(__DIR__ . '/Header/Part/HeaderPartFactory.php');
include_once(__DIR__ . '/Header/Part/MimeLiteralPartFactory.php');
include_once(__DIR__ . '/Message/MessageParser.php');
include_once(__DIR__ . '/Message/MimePartFactory.php');
include_once(__DIR__ . '/Message/Writer/MessageWriterService.php');
include_once(__DIR__ . '/Stream/UUDecodeStreamFilter.php');
include_once(__DIR__ . '/Stream/UUEncodeStreamFilter.php');
include_once(__DIR__ . '/Stream/CharsetStreamFilter.php');
include_once(__DIR__ . '/Stream/PartStream.php');
include_once(__DIR__ . '/Stream/Base64EncodeStreamFilter.php');
include_once(__DIR__ . '/Stream/Base64DecodeStreamFilter.php');
include_once(__DIR__ . '/Stream/PartStreamRegistry.php');
include_once(__DIR__ . '/Stream/Helper/CharsetConverter.php');
